  ...
  return (
    <div
      ...
      className={`z-10 py-3  fixed left-0 right-0 px-4 text-white ${
        solid ? "bg-gray-600 border-b-4 border-blue-400" : ""
      }`}
      style={{
    ...
    >
      <div className="container mx-auto items-center justify-between flex">
        ...
        <div>
          ...
          flex-col flex transition-all duration-1000 fixed top-0 h-full w-1/3 min-w-30rem border-r-2 border-blue-400 left-0 bg-black bg-opacity-70 justify-evenly text-2xl items-center
